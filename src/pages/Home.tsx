...
const testimonials = [
  { name: 'Jameson Thorne', role: 'Portfolio Manager, London', text: 'The institutional-grade tools and white-glove service at Bellinzone are unparalleled. My portfolio has never been more secure or more productive.' },
